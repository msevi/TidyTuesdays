...
This week's objective was to visualize the [achievement of African Americans](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-06-09/readme.md){target="_blank"}.
...
```{r fig.width= 48, fig.height=12, warning=FALSE, message=FALSE}
