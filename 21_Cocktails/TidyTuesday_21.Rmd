...
This week's objective was to visualize [cocktail data](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-05-26/readme.md){target="_blank"}. The idea for this week is to create a searchable table that categorizes cocktails in the form of a shiny app. 
