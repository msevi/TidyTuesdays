---
title: "TidyTuesday_2020_07_07"
output: github_document
---
# Tidy Tuesday: X-men

In this edition of TidyTuesday I will be looking at female representation in comics. The objective is to use [X-men data](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-06-30/readme.md){target="_blank"} and look at the Bechdel test indicator, which -according to [Wikipedia](https://en.wikipedia.org/wiki/Bechdel_test){target="_blank"}- is a measure of the representation of women in fiction. It asks whether a work features at least two women who talk to each other about something other than a man. The requirement that the two women must be named is sometimes added.
